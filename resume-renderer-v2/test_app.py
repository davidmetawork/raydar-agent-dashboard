        ...
        "sections": [
            {
                ...
                "entries": [
                    builder.entry(
                        "role-one",
                        ["Staff Software Engineer", "Northstar Health | 2022-Present"],
                        [
                    ...
                    builder.entry(
                        "role-two",
                        ["Senior Software Engineer", "Cedar Systems | 2019-2022"],
                        [
                    ...
                    builder.entry(
                        "role-three",
                        ["Software Engineer", "Common Thread Labs | 2016-2019"],
                        [
...
def long_ast(entry_count=10, bullets_per_entry=3, words_per_bullet=26):
    ...
    for index in range(entry_count):
        ...
        ast["sections"][0]["entries"].append(builder.entry(
            f"long-role-{index}",
            [f"Engineering Role {index + 1}", f"Industrial Company {index + 1} | {2026 - index}-{2027 - index}"],
            bodies,
        ))
    return ast, builder.claim_ids
